...
浅拷贝：只复制stack上的数据引用，不复制heap上的数据本身：![截屏2022-10-31 09.57.40](../../%E6%88%AA%E5%B1%8F2022-10-31%2009.57.40.png)

深拷贝：复制stack上的数据引用和heap上的数据：![截屏2022-10-31 09.58.19](../../%E6%88%AA%E5%B1%8F2022-10-31%2009.58.19.png)

### rust的所有权转移（move）

复制stack上的引用，将之前的引用销毁（图中s1变灰色），不复制heap上的数据本身：

![截屏2022-10-31 09.58.02](../../%E6%88%AA%E5%B1%8F2022-10-31%2009.58.02.png)
...
- 引用的本质（s作为s1的引用）：![截屏2022-10-31 12.59.46](../../%E6%88%AA%E5%B1%8F2022-10-31%2012.59.46.png)
